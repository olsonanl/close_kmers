...
public:
    ...
    std::string md5_to_fam(const std::string &md5);
...
public:
    ...
    void phase_1();
    void phase_1_body(const std::string &fam, std::vector<std::string> &fids);

    void phase_2();
    void phase_2_body(const std::string &nfam, std::vector<std::string> &nfids);

    void phase_3();
    void phase_3_body(const std::string &fam, std::vector<std::string> &fids);
